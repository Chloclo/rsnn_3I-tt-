...
class RSNN_i3(nn.Module):
    def __init__(self):
        ...
        p_nn = {'e_e': 0.2, 'e_PV': 0.2, 'e_SST': 0.2, 'e_Htr': 0.2,
                'PV_e': 0.2, 'PV_PV': 0.2, 'PV_SST': 0.2, 'PV_Htr': 0.2,
                'SST_e': 0.2, 'SST_PV': 0.2, 'SST_SST': 0.2, 'SST_Htr': 0.2,
                'Htr_e': 0.2, 'Htr_PV': 0.2, 'Htr_SST': 0.2, 'Htr_Htr': 0.2
                } 
